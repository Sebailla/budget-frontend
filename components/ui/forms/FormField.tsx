...
export const FormField = ({
    ...
    return (
        <div className="relative h-11 w-full min-w-[200px] my-1">
            <input
                className={clsx(
                    "peer h-full w-full rounded-md border border-border border-t-transparent bg-transparent px-3 py-3 font-body text-sm font-normal text-text-input outline-0 transition-all placeholder-shown:border placeholder-shown:border-slate-200 placeholder-shown:border-t-slate-200 focus:border-2 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-gray-50",
                    {
            ...
            <label
                className={clsx(
                    ...
                    {
                        "peer-focus:text-pastel-yellow-700 peer-focus:before:border-t-2 peer-focus:before:border-l-2 peer-focus:before:!border-pastel-yellow-400 peer-focus:after:border-t-2 peer-focus:after:border-r-2 peer-focus:after:!border-pastel-yellow-400" : color === "yellow",
